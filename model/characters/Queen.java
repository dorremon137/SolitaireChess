...
public class Queen implements Character {
    ...
    public ArrayList<ArrayList<Integer>> possibleMove(String[][] board) {
        ...
        for (ArrayList<Integer> a : possibleList) {
            if (a.get(0).equals(this.i - 3)) {
                int y = a.get(1);
                if (y == (this.j - 2) || y == (this.j - 1) || y == (this.j + 1) || y == (this.j + 2)) {
                    removeIndexes.add(possibleList.indexOf(a));
                }
            } else if (a.get(0).equals(this.i - 2)) {
                int y = a.get(1);
                if (y == (this.j - 3) || y == (this.j - 1) || y == (this.j + 1) || y == (this.j + 3)) {
                    removeIndexes.add(possibleList.indexOf(a));
                }
            } else if (a.get(0).equals(this.i - 1)) {
                int y = a.get(1);
                if (y == (this.j - 3) || y == (this.j - 2) || y == (this.j + 2) || y == (this.j + 3)) {
                    removeIndexes.add(possibleList.indexOf(a));
                }
            } else if (a.get(0).equals(this.i + 1)) {
                int y = a.get(1);
     ...
     *
     * @return - new copied queen
     */
    public Queen copy() {
        return new Queen(this.i, this.j);
    }
